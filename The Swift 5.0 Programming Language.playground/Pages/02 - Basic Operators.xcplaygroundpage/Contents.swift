...
//: - Logical AND (a && b)
//: - Logical OR (a || b)
//: - Note: The Swift logical operators `&&` and `||` are left-associative, meaning that compounds expressions with multiple logical operators evaluate the leftmost subexpression first.
